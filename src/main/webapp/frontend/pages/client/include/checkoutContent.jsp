				...
				<table class="table-cart-checkout mytable">
					...
					<c:forEach items="${cartProducts}" var="cartProduct" >
					 ...
					 <tr style="text-align: center;">
						    <td>
						    	<img src="/img/${cartProduct.productId}.png" alt="not found img" class="img-reponsive fix-size-img">
						    </td>
						    ...
						    <td class="donGia" >
						    	<div class="check " style ="display: inline-block; "><fmt:formatNumber value="${cartProduct.productPrice}" type="number" pattern="###0" /> VNĐ</div> 
						    	<div style="display: inline-block; "> x ${cartProduct.quantity}</div>
						    </td>
						    
						    <td>
						    	<div class="total"><fmt:formatNumber value="${cartProduct.productPrice*cartProduct.quantity}" type="number" pattern="###0" /> VNĐ</div> 
						    </td>
					</tr>
					</c:forEach>
